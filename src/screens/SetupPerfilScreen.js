...
const S = StyleSheet.create({
    ...
    uInput: { flex:1, paddingVertical:12, color:COLORS.text, fontSize:16 },
    err: { color:COLORS.error, fontSize:12, marginTop:6 },
    field: { backgroundColor:'rgba(255,255,255,0.04)', borderWidth:1, borderColor:'rgba(0,170,255,0.2)', borderRadius:14, paddingHorizontal:14, paddingVertical:12, color:COLORS.text, fontSize:15 },
