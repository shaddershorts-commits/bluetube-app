...
const styles = StyleSheet.create({
  ...
  emoji: { fontSize: 26 },
  searchRow: { flexDirection: 'row', alignItems: 'center', margin: 8, backgroundColor: COLORS.inputBg, borderRadius: 12, borderWidth: 1, borderColor: COLORS.border },
  ...
  gifImg: { width: '100%', height: '100%', borderRadius: 8, backgroundColor: COLORS.inputBg },
